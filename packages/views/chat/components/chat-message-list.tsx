...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@mantica/ui/components/ui/collapsible";
import { Bot, Loader2, ChevronRight, ChevronDown, Brain, AlertCircle } from "lucide-react";
import { api } from "@mantica/core/api";
import { Markdown } from "@mantica/views/common/markdown";
import type { ChatMessage, Agent, TaskMessagePayload } from "@mantica/core/types";
import type { ChatTimelineItem } from "@mantica/core/chat";
