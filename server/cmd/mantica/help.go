...
EXAMPLES
  ...
  $ mantica agent list --output json

ENVIRONMENT VARIABLES
  MANTICA_SERVER_URL    Override the default server URL
  MANTICA_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`mantica <command> <subcommand> --help`" + ` for more information about a command.
`
