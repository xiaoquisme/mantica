...
WHERE id = $1
RETURNING id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, default_model
`
...
RETURNING id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, scheduled_task_id
`
...
const cancelQueuedTasksByIssue = `-- name: CancelQueuedTasksByIssue :many
UPDATE agent_task_queue
SET status = 'cancelled'
...
func (q *Queries) CancelQueuedTasksByIssue(ctx context.Context, issueID pgtype.UUID) ([]AgentTaskQueue, error) {
	rows, err := q.db.Query(ctx, cancelQueuedTasksByIssue, issueID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
SELECT id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, default_model FROM agent
WHERE id = $1
`
...
SELECT id, agent_id, issue_id, status, priority, dispatched_at, started_at, completed_at, result, error, created_at, context, runtime_id, session_id, work_dir, trigger_comment_id, chat_session_id, scheduled_task_id FROM agent_task_queue
WHERE id = $1
`
...
SELECT id, workspace_id, name, avatar_url, runtime_mode, runtime_config, visibility, status, max_concurrent_tasks, owner_id, created_at, updated_at, description, runtime_id, instructions, archived_at, archived_by, default_model FROM agent WHERE runtime_id = $1 AND archived_at IS NULL
`
...
const reconcileStaleWorkingAgents = `-- name: ReconcileStaleWorkingAgents :many
UPDATE agent
...
func (q *Queries) ReconcileStaleWorkingAgents(ctx context.Context) ([]Agent, error) {
	rows, err := q.db.Query(ctx, reconcileStaleWorkingAgents)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const requeueOrphanedTasksByRuntime = `-- name: RequeueOrphanedTasksByRuntime :many
UPDATE agent_task_queue
...
func (q *Queries) RequeueOrphanedTasksByRuntime(ctx context.Context, runtimeID pgtype.UUID) ([]AgentTaskQueue, error) {
	rows, err := q.db.Query(ctx, requeueOrphanedTasksByRuntime, runtimeID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const requeueSweeperFailedTasksByRuntime = `-- name: RequeueSweeperFailedTasksByRuntime :many
UPDATE agent_task_queue
SET status = 'queued', dispatched_at = NULL, started_at = NULL, error = NULL
...
func (q *Queries) RequeueSweeperFailedTasksByRuntime(ctx context.Context, runtimeID pgtype.UUID) ([]AgentTaskQueue, error) {
	rows, err := q.db.Query(ctx, requeueSweeperFailedTasksByRuntime, runtimeID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
