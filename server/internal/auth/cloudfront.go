...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.mantica.ai"
	cookieDomain string // cookie scope, e.g. ".mantica.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.mantica.ai")
//   - COOKIE_DOMAIN           (e.g. ".mantica.ai")
